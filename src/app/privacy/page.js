          ...
          <div className="prose prose-zinc dark:prose-invert max-w-none space-y-8 text-lg font-medium leading-relaxed">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-4">
                ...
                <li>
                  <strong>Website</strong> refers to AlertyAI, accessible from <a href="https://alertyai.com" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">https://alertyai.com</a>.
                </li>
                <li>
            ...
            <section>
              <h2 className="text-2xl font-bold mt-8 mb-4 uppercase tracking-tight">Your Rights</h2>
              <p>
              ...
              <p>
                To make a privacy request, contact us by email. We may verify your identity before completing requests.
              </p>
            </section>

            <section>
              <h2 className="text-2xl font-bold mt-8 mb-4 uppercase tracking-tight">International Data Transfers</h2>
              <p>
                Our service providers may process data in countries other than your own. Where required, we use appropriate safeguards for cross-border data transfer.
              </p>
            </section>
